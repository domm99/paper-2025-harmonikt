...
\and
\IEEEauthorblockN{Giovanni Delnevo}
\IEEEauthorblockA{%\textit{dept. name of organization (of Aff.)} \\
\textit{University of Bologna}\\
Cesena, Italy \\
giovanni.delnevo@unibo.it}
\and
...
rely heavily on mobile robots to streamline logistics operations and ensure worker safety.
% 
At the same time, 
...
\begin{IEEEkeywords}
Industry 4.0, Middleware, Heterogeneous Robot Fleets, Microservices, REST API
\end{IEEEkeywords}
...
The rest of the paper is organized as follows:
 ...
 \Cref{sec:arc} introduces \approach{} discussing both the high level architecture and the implementation;
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=1\columnwidth]{images/robots2.jpg}
    \caption{
...
Another promising direction stems from the broader edge-cloud continuum~\cite{gkonis2023survey}. 
%
...
%
This work was also supported by the FAIR foundation, 
 funded by the European Commission under the NextGenerationEU programme 
 (PNRR, M4C2, Investimento 1.3, Partenariato Esteso PE00000013, Spoke 8 “Pervasive AI”).
